      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
              ...
              <CardHeader>
                <div className="flex justify-center mb-4">
                  <Avatar className="w-24 h-24">
                    <AvatarImage src="/profile.jpg" alt={SITE_CONFIG.name} />
                    <AvatarFallback className="text-xl">JL</AvatarFallback>
                  </Avatar>
                </div>
                <CardTitle className="text-xl">{SITE_CONFIG.name}</CardTitle>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Quick Skills</CardTitle>
              </CardHeader>
              <CardContent>
